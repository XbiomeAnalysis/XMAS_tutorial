...
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "rarefy")
...
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "TSS")
```
...
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "TMM")
```
...
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "RLE")
```
...
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "CSS")
```

* **CLR**: centered log-ratio normalization.
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "CLR")
```

* **CPM**: pre-sample normalization of the sum of the values to 1e+06.
```{r, warning=FALSE, message=FALSE}
XMAS2::normalize(dada2_ps_genus, method = "CPM")
```
...
```{r, warning=FALSE, message=FALSE}
metaphlan2_ps_genus_LRA <- summarize_LowAbundance_taxa(metaphlan2_ps_genus, cutoff = 1e-04, unclass = TRUE)

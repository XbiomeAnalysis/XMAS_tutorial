...
```{r, warning=FALSE, message=FALSE}
dada2_ps_genus_rb <- normalize(dada2_ps_genus, method = "TSS")
dada2_ps_genus_rb
```
...
```{r, warning=FALSE, message=FALSE}
core_taxa_name <- core_members(dada2_ps_genus_rb, detection = 0.01, prevalence = 0.8)
...
```{r, warning=FALSE, message=FALSE}
core_abundance <- sample_sums(phyloseq_core_taxa(dada2_ps_genus_rb, detection = 0.01, prevalence = 0.8))
...
pl_core <- plot_core_taxa(dada2_ps_genus_rb, 
                    plot.type = "heatmap", 

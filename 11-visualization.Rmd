...
```{r, warning=FALSE, message=FALSE, fig.align="center", fig.width=8, fig.height=6, fig.cap="plot_stacked_bar_XIVZ (test1)"}
plot_stacked_bar_XIVZ(phyloseq = dada2_ps_rarefy, level = "Family")
```


* Set feature parameter to show feature information
```{r, warning=FALSE, message=FALSE, fig.align="center", fig.width=8, fig.height=8, fig.cap="plot_stacked_bar_XIVZ (test2)"}
...
```{r, warning=FALSE, message=FALSE, fig.align="center", fig.width=8, fig.height=8, fig.cap="plot_stacked_bar_XIVZ (test3)"}
...
```{r, warning=FALSE, message=FALSE, fig.align="center", fig.width=8, fig.height=8, fig.cap="plot_stacked_bar_XIVZ (test4)"}
plot_stacked_bar_XIVZ(phyloseq = dada2_ps_rarefy, 
                 level = "Family", 

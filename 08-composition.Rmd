...
dada2_ps_remove_BRS_genus <- summarize_taxa(dada2_ps_remove_BRS, taxa_level = "Genus")
otu_tab <- phyloseq::otu_table(dada2_ps_remove_BRS_genus)
sam_tab <- phyloseq::sample_data(dada2_ps_remove_BRS_genus)
plot_StackBarPlot(
      data_otu=otu_tab,
      data_sam=sam_tab,
      cutoff = 0.01,
...
plot_taxa_heatmap(dada2_ps_remove_BRS, 
                  taxa_level = "Phylum", 
                  cutoff = 1e-4, 
